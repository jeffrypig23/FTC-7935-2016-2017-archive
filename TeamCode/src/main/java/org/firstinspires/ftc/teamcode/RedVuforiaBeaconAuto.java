...
@Autonomous(name = "Red Beacon Auto", group = "Test")
@Disabled

public class RedVuforiaBeaconAuto extends LinearOpMode {

    //<editor-fold desc="Global variables and objects">
    ...
    public void runOpMode() throws InterruptedException {
        ...
        leftFrontMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);   /* This section is  */
        rightFrontMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);  /*       ()()       */
        leftBackMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);    /*     (' .')       */
        rightBackMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);   /*     () ())       */
        shooterMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);     /*    () ()_)*      */
        intakeMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);      /*  Bunny approved! */
        ...
        while (opModeIsActive() && (!gamepad1.x)){
            ...
            if (stage == 0) {
                ...
                //<editor-fold desc="Step 1: Drive forward, to get in front of the first beacon (8 feet)">
                driveDistance(leftFrontMotor, 0.5, 8 * 12 * mmPerInch);
                driveDistance(leftBackMotor, 0.5, 8 * 12 * mmPerInch);
                driveDistance(rightFrontMotor, 0.5, 8 * 12 * mmPerInch);
                driveDistance(rightBackMotor, 0.5, 8 * 12 * mmPerInch);
                ...
                //<editor-fold desc="Step 2: Turn towards beacon">
                ...
                //<editor-fold desc="Step 3: Wait for Vuforia to find the image (It's slow)">
                runtime.reset();

                while (runtime.seconds() <= 1) {
                    // This is just to wait for the image to be found by Vuforia
                ...
                //<editor-fold desc="Step 4: Get 300 mm within the beacon (In front of)">
                ...
                if (pose != null) {
                    ...
                    if (beacondesc > 25) {
                    ...
                    } else if (beacondesc < -25) {

                        //<editor-fold desc="Go forwards">
                        leftFrontMotor.setDirection(DcMotorSimple.Direction.FORWARD);
                        rightFrontMotor.setDirection(DcMotorSimple.Direction.REVERSE);
                        leftBackMotor.setDirection(DcMotorSimple.Direction.REVERSE);
                        rightBackMotor.setDirection(DcMotorSimple.Direction.FORWARD);
                        ...
                        //<editor-fold desc="Positioning was successful!">
                        leftFrontMotor.setPower(0.0);
                        leftBackMotor.setPower(0.0);
                        rightFrontMotor.setPower(0.0);
                        rightBackMotor.setPower(0.0);
                ...
                //<editor-fold desc="Step 5: Get frame as object rgb of type Image">
                ...
                for (int q = 1; q <= 15; q++) {
                    ...
                    while (runtime.milliseconds() <= 500) {
                        ...
                        // Add a delay, give the phone some time to find the image!

                        // This just updates the color for a duration of 1,000,000,000 nanoseconds, in case the above color was an ERROR
                        color = beaconColor(rgb, wheels, vuforia.getCameraCalibration(), false);
                        //negative means blue-red, positive means red-blue, zero means error
                    }
                ...
                //<editor-fold desc="Step 6: Press a button!">

                // Based on beacon config (Red | Blue) Program is red btw (Drive to the left)

                if (needButtonServo) {
                    buttonServo.setPosition(ButtonServoDown);
                } else {
                    buttonServo.setPosition(ButtonServoUp);
                }
                ...
                telemetry.addData("Status", "Pushing the button...");
                ...
                //<editor-fold desc="Step 7: Backup">
                /*
                driveDistance(leftFrontMotor, 0.5, 300);
                driveDistance(leftBackMotor, 0.5, 300);
                driveDistance(rightFrontMotor, 0.5, 300);
        ...
        telemetry.clearAll();
        telemetry.addData("Status", "OpMode No Longer Active");
        telemetry.update();
        ...
        if (img != null && img.getPixels() != null && pose != null) {
			...
			*/
            ...
            if (centroid.x < mask.cols() / 2) {
                beaconConfig = "Red Blue"; // Flipped from Blue Red to Red Blue
                color = 1; // Changed from -1 to 1
            } else {
                beaconConfig = "Blue Red"; // Flipped from Red Blue to Blue Red
                color = -1; // Changed from 1 to -1
            }
