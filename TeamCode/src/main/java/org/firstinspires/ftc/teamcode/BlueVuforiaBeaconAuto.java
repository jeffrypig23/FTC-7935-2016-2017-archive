...
@Autonomous(name="Blue Beacon Auto", group ="Test")
@Disabled

public class BlueVuforiaBeaconAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            // Change the RC background to blue!
            ...
            if (stage == -2) {
                ...
                telemetry.addData("Solution", "Yell at Stephen");
            ...
            if (stage == 0) {
                ...
                //<editor-fold desc="Step 1: Drive forward, to get in front of the first beacon (67.165 inches)">
                driveDistance(leftFrontMotor, 0.5, 67.165 * mmPerInch);
                driveDistance(leftBackMotor, 0.5, 67.165 * mmPerInch);
                driveDistance(rightFrontMotor, 0.5, 67.165 * mmPerInch);
                driveDistance(rightBackMotor, 0.5, 67.165 * mmPerInch);
                ...
                driveDistance(leftFrontMotor, 0.5, .8 * mmPerInch);
                driveDistance(leftBackMotor, 0.5, .8 * mmPerInch);
                rightBackMotor.setPower(0.0);
                rightFrontMotor.setPower(0.0);

                telemetry.addData("Status", "Turning to face beacon...");

                if (isRightPos(leftBackMotor, 100) && isRightPos(leftFrontMotor, 100)) {
                ...
                if (pose != null) {
                    ...
                    if (beacondesc > 25) {
                        ...
                        driveDistance(leftFrontMotor, 0.25, -300);
                        driveDistance(leftBackMotor, 0.25, -300);
                        driveDistance(rightFrontMotor, 0.25, -300);
                        driveDistance(rightBackMotor, 0.25, -300);
                ...
                // Based on beacon config (Red | Blue) Program is blue btw (Drive to the right)

            } else if (stage == 6) {

                // Based on beacon config (Blue | Red) Program is blue btw (Drive to the left)
